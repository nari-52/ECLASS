				...
				$.ajax({
					...
					success:function(json){
						...
						var html = "<div id='changeG'>";
							...
							html +="<label for='gradeA'>A</label><label for='gradeB'>B</label><label for='gradeC'>C</label><label for='gradeD'>D</label><label for='gradeF'>F</label><br/>";
							html +="<input type='radio' name='grade' id='gradeA'/>";
							html +="<input type='radio' name='grade' id='gradeB'/>";
							html +="<input type='radio' name='grade' id='gradeC'/>";
							html +="<input type='radio' name='grade' id='gradeD'/>";
							html +="<input type='radio' name='grade' id='gradeF'/><br/>";
