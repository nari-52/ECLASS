	   ...
	   // 작성버튼
	      $("#write").click(function(){
		    ...
		    */    
	         ...
	         frm.method = "POST";
	         frm.action = "<%= ctxPath%>/board/editquestionboardEnd.up";
	         frm.submit();
	      });
		...
		<form name="editFrm" enctype="multipart/form-data">
			<table id="table" style="margin: 0 auto; width: 1040px; background-color: white;">
				<tr>
					<th>제목</th>
					<td>
						<input type="text" size="50" id="title" name="title" value="${questionvo.title}" />
						...
						<input type="text" name="question_seq" value="${questionvo.question_seq}" />
					</td>
				</tr>
				...
				<tr>
					<th>내용</th>
					<td><textarea rows="15" cols="110" id="content" name="content" >${questionvo.content}</textarea></td>
				</tr>
