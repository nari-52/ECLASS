...
<script>
	...
	function goSubmit() {
        ...
        frm.method = "POST";
        frm.action = "<%=ctxPath%>/examRegister.up";
        frm.submit(); 
	}
...
<div id="contentsWrap">
	...
	<form id="registerFrm" name="registerFrm">
		<span id="inputTitle" style="margin-right: 10px;">시험 제목</span><input type="text" id="examTitle" name="examTitle" style="height: 40px; width: 1000px;" />
		<br><br>
		<span id="inputDate" style="margin-right: 10px;">시험 날짜</span><input type="text" id="datepicker" />
	</form>
