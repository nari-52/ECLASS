...
<body>
	<div class="Mycontainer">
        ...
        <div class="contentNavi">
            ...
            <span class="contentNaviFont SopportNaviFnt"><a href='<%= ctxPath%>/donation/donationSupporter.up?donseq=${donstoryPage.donseq}'> 후원자 </a></span>
        </div>
			...
			<div class="contents">
				...
				<div class="info">				
					...
					<c:if test="${not empty donstoryPage}">
						<div class="donImg">
							<img alt="${donstoryPage.subject}" src="<%= ctxPath%>/resources/images/${donstoryPage.storyImg}" />
						</div>
						<div class="donInfo-table">
	                        <dl style="margin: 20px 0;">
								<%-- <dt>${donstoryPage.donDueDate-donstoryPage.donDate}21일 남음</dt> --%>
								<dt>${donstoryPage.donDueDate}21일 남음</dt>
								<div style="border-bottom: solid 4px #00BCD4; width: 120px; padding-bottom: 10px" align="center"></div>
	                        </dl>
	                                               
							<dl class="underLine">
								<dt><fmt:formatNumber value="${(donstoryPage.totalPayment)/donstoryPage.targetAmount}" pattern="0.0%"/>달성</dt>
							</dl>
							<dl class="underLine">
								<dt>${donstoryPage.totalPayment}1,000,000원 펀딩</dt>
							</dl>                         
							<dl>
								<dt>${donstoryPage.totalSupporter}50명의 후원자</dt>
							</dl>
                ...
                <div class="contentStoryImage">
						<img alt="Donation Story " src="#" />
					</div>
