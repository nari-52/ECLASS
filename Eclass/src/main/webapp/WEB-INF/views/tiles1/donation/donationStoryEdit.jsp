...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		//$('.datepicker').datepicker('donDate', 'donDueDate');
	      ...
	      $("#edit").click(function(){
		    ...
		    */    
	        ...
	        if(contentVal == "") {
	         ...
	         frm.method = "POST";
	         frm.action = "<%= ctxPath%>/donation/donationStoryEditEnd.up";
	         frm.submit();
	      });
	...
	<div id="wholeNotice">
		...
		<form name="editFrm" enctype="multipart/form-data">
			<table id="table" style="margin: 0 auto; width: 1040px; background-color: white;">
				<tr>
					<th>후원제목</th>
					<td><input type="text" size="50" id="title" name="subject" value="${donstoryvo.subject}"/></td>
				</tr>
				
				<tr>
					<th>작성자</th>
					<td><input type="text" name="name" style="color: gray;" value="${sessionScope.loginuser.name}" readonly/></td>
				</tr>
				...
				<tr>
					<th>목표금액 </th>
					<td><input type="text" name="targetAmount" value="${donstoryvo.targetAmount}"/></td>
				</tr>
		...
		<div style="margin: 0 auto; width: 300px; margin-bottom: 20px; margin-top: 20px">
			<button type="button" style="width: 140px; border:solid 1px #ddd; border-radius:3px" id="edit">수정</button>
