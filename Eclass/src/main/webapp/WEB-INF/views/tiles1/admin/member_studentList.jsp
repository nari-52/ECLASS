...
*/
	...
	$(document).ready(function(){ 
		...
		// 회원 탈퇴하기 버튼 클릭	
		$(".student_delMember").click(function(){
			
			var useridVal = $(this).val();
			
			if(confirm("탈퇴처리 하시겠습니까?") == true){
				$.ajax({
					url: "<%=ctxPath%>/admin/student_delMember.up",
...
<div id="adminContainer" style="margin-bottom: 70px;">
	<h2 style="text-align: center;">학생회원 리스트</h2>
				...
				<tr>
					...
					<td>
						<form name="delMember">
							...
							<button name="student_delMember" class="student_delMember" value="${membervo.userid}"  style="margin-left: 50px; margin-right: -30px;">탈퇴처리</button>
						</form>
					</td>
				</tr>
			</c:forEach>
